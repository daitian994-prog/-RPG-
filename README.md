...
当前版本：**v0.2.0**。版本创建、离线备份与安全恢复方法见 [版本说明.md](版本说明.md)。
...
- 五维人格与守护/强者/流浪/灵界/破局五类命运权重公开显示，并真实影响事件概率
- 事件结算逐项说明属性、人格、命运、NPC 关系和物品变化
- AI 事件统一奖罚层：选项提前显示风险、检定属性与预估胜算
- 非战斗事件拥有大成功、成功、代价成功、失败四级结果；奖励会缩放，失败会造成受伤、关系下降、命运受挫或错失物品
