...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    {screen === 'game' && game && world && <GamePage game={game} world={world} event={event} result={result} tab={tab} busy={busy} eventState={eventState} onTab={setTab} onTravel={travel} onChoice={choose} onDialogue={dialogue} onCloseEvent={() => { requestRef.current.controller?.abort(); setEvent(null); setBusy(false); setEventState('IDLE') }}/>} 
